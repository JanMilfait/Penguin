...
export const PostApi = apiSlice.injectEndpoints({
  endpoints: (builder) => ({
    ...
    addPost: builder.mutation<T.Post, T.AddPostArg>({
      query: ({formData}) => ({
        url: '/api/post',
        method: 'POST',
        body: formData
    ...
    updatePost: builder.mutation<T.Post, T.updatePostArg>({
      query: ({id, formData}) => ({
        url: '/api/post/' + id,
        method: 'PUT',
        body: formData
    ...
    unreactPost: builder.mutation<MessageResponse, T.ReactPostArg>({
      query: ({id}) => ({
        url: '/api/post/' + id + '/reaction',
        method: 'DELETE'
      }),
